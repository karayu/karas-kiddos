  ...
  return (
    <>
      ...
      <main className="pb-20">
        ...
        {/* Bedtime Checklist Shelf */}
        <div className="mt-6">
          <div className="px-4 mb-3 flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold">Bedtime Checklist</h2>
        ...
        <div className="mt-8">
          <div className="px-4 mb-3 flex items-center justify-between">
            <div>
              <h2 className="text-xl font-bold">Bedtime Story</h2>
              <p className="text-sm text-[#617c89] dark:text-[#a0b3bd] mt-1">
                ...
                {stories && stories.length > 0 ? (
                  stories.map((story: any) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        <p className="font-medium line-clamp-2 text-sm">{story.title}</p>
                      </div>
                    </Link>
                  ))
                ) : (
